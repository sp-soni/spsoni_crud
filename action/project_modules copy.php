...
if (!empty($_GET['module_id'])) {
    ...
    if (!empty($EDIT_ROW['id'])) {
        ...
        $model_parent_class =  $EDIT_ROW['model_parent_class'];
...
if (!empty($_POST)) {
    ...
    $model_parent_class = $_POST['model_parent_class'];
    ...
    if (empty($_POST['model_parent_class'])) {
        $error[] = 'Model Parent Class is required';
    }
    ...
    if (empty($error)) {
        if ($module_id == 0) { // insert
            $sql = "INSERT INTO project_module (`project_id`,`module`,`controller_parent_class`,`model_parent_class`, `controller_path`, `model_path`, `view_path`)
        VALUES ('" . $project_id . "','" . $module . "','" . mysqli_real_escape_string($conn_app, $controller_parent_class) . "','" . mysqli_real_escape_string($conn_app, $model_parent_class) . "','" . mysqli_real_escape_string($conn_app, $controller_path) . "',
        '" . mysqli_real_escape_string($conn_app, $model_path) . "','" . mysqli_real_escape_string($conn_app, $view_path) . "')";
            ...
            `model_parent_class`='" . mysqli_real_escape_string($conn_app, $model_parent_class) . "', 
