...
CREATE TABLE IF NOT EXISTS `project` (
  ...
  `base_model_prefix` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `project` (`id`, `db_name`, `platform`, `base_model_prefix`, `controller_prefix`, `route_prefix`, `project_name`, `controller_path`, `model_path`, `view_path`, `route_path`) VALUES
