...
function generate_base_model($className, $columns, $table, $table_attributes)
{
    ...
    foreach ($columns as $column) {
        $properties .= "\tpublic $" . $column . ";" . PHP_EOL;
    }
    $properties .= PHP_EOL;
...
/**
 * This file is generated by SpiTech Code Generator tool(SGT).
 * This is generated on the basis of database table structure.
 * Developers are not supposed to do any chnages in this file. If there is any need of change then we need to apply the change
 * in the database>table structure and regenerate the Base Models from SGT.
 */
